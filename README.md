...
As mentioned, you don't need a production-strength cluster for this task so we're using the **KinD** tool which is purpose built for quickly standing-up disposable sandbox environments.
